Rails.application.configure do
  ...
  # Enable usage of better_error pages in dev and test on hosts facing the internet
  # set the environment variable TRUSTED_IP to your current IP and run 'rails s'
